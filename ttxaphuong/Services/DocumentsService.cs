...
namespace ttxaphuong.Services
{
    public class DocumentsService : IDocumentsService
    {
        ...
        //public async Task<IEnumerable<DocumentsDTO>> GetDocuments1()
        //{
        //    try
        //    {
        //        var documents = await _context.Documents
        //            .Include(h => h.Category_Documents)
        //            .Include(h => h.Accounts).Where(h => h.IsVisible == true)
        //            .ToListAsync();
        //        return _mapper.Map<IEnumerable<DocumentsDTO>>(documents);
        //    }
        //    catch (Exception ex)
        //    {
        //        throw new Exception("Có lỗi xảy ra khi lấy danh sách văn bản và pháp luật" + ex.Message, ex);
        //    }
        //}
        ...
        public async Task<DocumentsDTO> GetDocByNameAsync(string name)
        {
            try
            {
                ...
                //var doc = await _context.Documents.FirstOrDefaultAsync(h=>NormalizeTitle(h.Title) == normalizedInput);
