            ...
            modelBuilder.Entity("ttxaphuong.Models.Accounts.AccountsModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id_account = 1,
                            Create_at = new DateTime(2025, 3, 23, 8, 34, 31, 324, DateTimeKind.Utc).AddTicks(1451),
                        ...
                        {
                            Id_account = 2,
                            Create_at = new DateTime(2025, 3, 23, 8, 34, 31, 324, DateTimeKind.Utc).AddTicks(1455),
            ...
            modelBuilder.Entity("ttxaphuong.Models.Accounts.PermissionsModel", b =>
                {
                    ...
                    b.Property<int?>("AccountsId_account")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ttxaphuong.Models.Accounts.PermissionsModel", b =>
                {
                    b.HasOne("ttxaphuong.Models.Accounts.AccountsModel", "Accounts")
                        .WithMany()
                        .HasForeignKey("AccountsId_account");
