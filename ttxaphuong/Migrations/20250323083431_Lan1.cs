        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountsId_account = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2025, 3, 23, 8, 34, 31, 324, DateTimeKind.Utc).AddTicks(1451), "hoanguyentranthi32@gmail.com", "Nguyễn Trần Thị Hòa", "03092003", null, null, "Manager", "IsActive", "ThiHoa", null },
                    { 2, null, new DateTime(2025, 3, 23, 8, 34, 31, 324, DateTimeKind.Utc).AddTicks(1455), "TuiLaHoa25@gmail.com", "Nguyễn Hòa Trần Thị", "123456789", null, null, "Admin", "IsActive", "HoaThi", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Permissions",
                columns: new[] { "Id", "AccountsId_account", "CanAddUser", "CanDeleteUser", "CanEditUser", "CanManagePermissions", "CanManageRoles", "CanViewUsers", "ManagerId" },
                values: new object[,]
                {
                    { 1, null, true, true, true, true, true, true, 2 },
                    { 2, null, false, false, false, false, false, true, 1 }
                });
